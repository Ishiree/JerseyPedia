    ...
    <div class="container">
        ...
        <div class="row mt-4">
            <div class="col">
                ...
                <p>Untuk pembayaran silahkan dapat transfer ke rekening di bawah ini sebesar : <strong>Rp. {{ number_format($total_harga) }}</strong> </p>
                <div class="media">
            ...
            <div class="col">
                ...
                <form wire:submit.prevent="checkout">
                    ...
                    <button type="submit" class="btn btn-success float-right"><i class="fas fa-arrow-right"></i> Checkout</button>
                </form>
            </div>
        </div>
