                ...
                <table class="table text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $pesanan_detail->total_harga }}</td>
                            <td><i wire:click="destroy({{ $pesanan_detail->id }})" class="fas fa-trash text-danger"></i></td>
                        </tr>
                        @empty
                        <tr>
                        ...
                        <tr>
                            <td colspan="6" align="right" style="border-top: hidden"><strong>Kode Unik : </strong></td>
                            <td style="border-top: hidden"><strong>Rp. {{number_format($pesanan->kode_unik)}}</strong></td>
                            <td style="border-top: hidden"></td>
                        </tr>
                        <tr>
                            <td colspan="6" align="right" style="border-top: hidden"><strong>Total Yang Harus Dibayar : </strong></td>
                            <td style="border-top: hidden"><strong>Rp. {{number_format($pesanan->total_harga+$pesanan->kode_unik)}}</strong></td>
                            <td style="border-top: hidden"></td>
                        </tr>
                        <tr>
